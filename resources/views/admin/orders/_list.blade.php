        ...
        <div class="col-12 col-md-6 col-xl-4">
            <article class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    ...
                    <p class="small text-secondary">{{ $order->created_at?->format('d/m/Y H:i') }}</p>
                    ...
                    <p class="small text-secondary">{{ App\Models\Order::PAYMENT_TYPES[$order->payment_type] ?? $order->payment_type ?? 'Belum ada pembayaran' }}</p>
